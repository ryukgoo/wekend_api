...
@DynamoDBTable(tableName = Configuration.RECEIVE_MAIL_TABLE)
public class ReceiveMail {
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = Configuration.RECEIVE_MAIL_INDEX_USERID_RESPONSETIME)
    ...
    @DynamoDBIndexRangeKey(globalSecondaryIndexName = Configuration.RECEIVE_MAIL_INDEX_USERID_RESPONSETIME)
    ...
    @DynamoDBAttribute(attributeName = Configuration.ATTRIBUTE_MAIL_SENDER_ID)
    @DynamoDBIndexHashKey(globalSecondaryIndexName = "SenderId-index")
