...
public class CreateCampaignThumbImage implements RequestHandler<S3Event, String> {

	private static final String DST_BUCKET = "entuition-product-images-thumb";
	private static final float MAX_WIDTH = (float) 256.0;
	private static final float MAX_HEIGHT = (float) 256.0;
